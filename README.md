...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Unique Hub | crack ",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
...
loadstring(game:HttpGet(('https://raw.githubusercontent.com/Kahack999/ka/main/fast%20attack%20bf.txt'),true))()
...
Main:AddToggle("FastAttack [3]|",true,function(value)
	_G.FastAttack = value
end)
coroutine.wrap(function()
